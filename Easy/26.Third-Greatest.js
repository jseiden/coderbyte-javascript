// Using the JavaScript language, have the function ThirdGreatest(strArr) take the array of strings stored in strArr 
...
function ThirdGreatest(StrArr) {
  var results = [];
  var sorted = StrArr.sort(function(str1, str2){return str2.length - str1.length});
  return sorted[2];
}
